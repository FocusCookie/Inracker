...
type OverlayProps = OverlayMap["npc.create"];
...
function CreateNPCDrawer({
  ...
  return (
    ...
    >
      <CreateNPCForm form={form} disabled={isCreating}>
...
export default CreateNPCDrawer;
