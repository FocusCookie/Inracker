...
function EmojiPicker({
  ...
  const currentLocale = (locale ?? i18n.language.split("-")[0]) as any;
...
function EmojiPickerEmoji({
  ...
  return (
    <button
      {...props}
      className={cn(
        "data-[active]:bg-accent/80 relative flex size-8 items-center justify-center overflow-hidden rounded-md text-lg before:absolute before:inset-0 before:-z-10 before:hidden before:items-center before:justify-center before:text-[2.5em] before:blur-lg before:saturate-200 before:content-(--emoji) hover:cursor-pointer data-[active]:before:flex",
        className,
      )}
      style={
        {
