...
type OverlayProps = OverlayMap["weakness.create"];
...
export default function CreateWeaknessDrawer({
  open,
  onCreate,
  onComplete,
  onCancel,
  ...
  const { t } = useTranslation("ComponentCreateWeaknessDrawer");
