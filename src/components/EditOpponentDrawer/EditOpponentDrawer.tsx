...
type OverlayProps = OverlayMap["opponent.edit"];
...
function EditOpponentDrawer({
  ...
  const { t } = useTranslation("ComponentEditOpponentDrawer");
...
export default EditOpponentDrawer;
