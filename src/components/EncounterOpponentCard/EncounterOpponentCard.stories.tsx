...
import EncounterOpponentCard from "./EncounterOpponentCard";
import { fn } from "@storybook/test";

const meta = {
  title: "Components/EncounterOpponentCard",
  component: EncounterOpponentCard,
  args: {
    opponent: {
      id: 1,
      name: "Test Opponent",
...
} satisfies Meta<typeof EncounterOpponentCard>;
